...
- [01-project-scaffold.md](01-project-scaffold.md) — Go module, Makefile gates, CI, health server.
- [02-s3-object-store.md](02-s3-object-store.md) — `Store` interface + S3 and in-memory impls for objects/packs.
